...
<body class="hold-transition login-page">
  ...
  <h1 class="text-center text-white px-4 py-5" id="page-title"><b><?php echo $_settings->info('name') ?> - Student Signup</b></h1>
<div class="login-box">
  <div class="card card-navy my-2">
    <div class="card-body">
      ...
      <form id="signup-frm" action="" method="post">
        ...
        <div class="input-group mb-3">
          <input type="text" class="form-control" name="lrn" placeholder="LRN (12 digits)" maxlength="12" required>
          <div class="input-group-append">
            <div class="input-group-text">
...
<script>
  $(document).ready(function(){
    ...
    $('#signup-frm').submit(function(e){
      ...
      $.ajax({
        url: '<?= base_url ?>classes/Login.php?f=signup_student',
        method: 'POST',
        data: data,
        dataType: 'json',
