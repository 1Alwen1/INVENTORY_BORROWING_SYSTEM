	...
	<div class="card-body">
        <div class="container-fluid">
			<table class="table table-hover table-striped table-bordered" id="list">
				...
				<tbody>
					<?php
					$conn->query("ALTER TABLE item_list ADD COLUMN IF NOT EXISTS available int(11) NOT NULL DEFAULT 1");
					$i = 1;
						...
						while($row = $qry->fetch_assoc()):
							...
							$available = $conn->query("SELECT SUM(available) as avail FROM `item_list` where `category_id` = '{$row['id']}' ")->fetch_assoc()['avail'] ?? 0;
					?>
						<tr>
