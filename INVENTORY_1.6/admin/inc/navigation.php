                ...
                <nav class="mt-1">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item dropdown">
                      <a href="./?page=borrow" class="nav-link nav-borrow">
                    ...
                    <li class="nav-item dropdown">
                      <a href="./?page=reservation" class="nav-link nav-reservation">
                    ...
                    <li class="nav-item dropdown">
                      <a href="./?page=damage" class="nav-link nav-damage">
                    ...
                    <?php if($_settings->userdata('login_type') == 1 || $_settings->userdata('login_type') == 3): ?>
                    ...
                    <li class="nav-item dropdown">
                      <a href="./?page=item" class="nav-link nav-item">
                    ...
                    <li class="nav-item dropdown">
                      <a href="./?page=accessories" class="nav-link nav-accessories">
                        <i class="nav-icon fas fa-border-all"></i>
                        <p>
                          Accessories List
                        </p>
